...
namespace VidyoClient
{
	...
	public class RoomStats{
		...
		public RoomStats(IntPtr obj){
			...
			int nSelectedParticipantsStatsSize = 0;
			IntPtr nSelectedParticipantsStats = VidyoRoomStatsGetselectedParticipantsStatsArrayNative(VidyoRoomStatsGetselectedParticipantsStatsNative(objPtr), ref nSelectedParticipantsStatsSize);
			int nSelectedParticipantsStatsIndex = 0;
