...
namespace VidyoClient
{
	...
	public class EndpointStats{
		...
		public EndpointStats(IntPtr obj){
			...
			int nVirtualAudioSourceStatsSize = 0;
			IntPtr nVirtualAudioSourceStats = VidyoEndpointStatsGetvirtualAudioSourceStatsArrayNative(VidyoEndpointStatsGetvirtualAudioSourceStatsNative(objPtr), ref nVirtualAudioSourceStatsSize);
			int nVirtualAudioSourceStatsIndex = 0;
