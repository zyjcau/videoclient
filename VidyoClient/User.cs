...
namespace VidyoClient
{
	public class User: IDisposable {
		...
		private OnGetCurrentRosterComplete _mOnGetCurrentRosterComplete;
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		...
		public Boolean GetCurrentRoster(IGetCurrentRoster _iIGetCurrentRoster){
			...
			_mOnGetCurrentRosterComplete = OnGetCurrentRosterCompleteDelegate;
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnGetCurrentRosterComplete))]
		...
		private static void OnGetCurrentRosterCompleteDelegate(IntPtr u, IntPtr roster){
			...
			int nRosterSize = 0;
			IntPtr nRoster = VidyoUserOnGetCurrentRosterCompleteGetrosterArrayNative(roster, ref nRosterSize);
			int nRosterIndex = 0;
			...
			if(csU._mIGetCurrentRoster != null)
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnGetRecordingServiceProfiles))]
		...
		private static void OnGetRecordingServiceProfilesDelegate(IntPtr u, IntPtr profiles, IntPtr prefixes, UserRecordingServiceResult result){
			...
			int nProfilesSize = 0;
			IntPtr nProfiles = VidyoUserOnGetRecordingServiceProfilesGetprofilesArrayNative(profiles, ref nProfilesSize);
			...
			int nPrefixesSize = 0;
			IntPtr nPrefixes = VidyoUserOnGetRecordingServiceProfilesGetprefixesArrayNative(prefixes, ref nPrefixesSize);
			...
			if(csU._mIGetRecordingServiceProfiles != null)
